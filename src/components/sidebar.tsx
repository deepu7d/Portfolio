  ...
  return (
    <div className="sticky top-0 flex h-dvh flex-col items-center gap-10 border-r-2 border-neutral-800/50 p-8 pt-8 lg:pt-10">
      ...
      <div className="flex flex-col gap-10 pt-5 text-lg">
        ...
        <a
          href="https://leetcode.com/u/deepu7d/"
          className="flex items-center justify-center gap-2 hover:text-blue-400"
          target="_blank"
        >
          <IconBrandLeetcode />
...
const InstagramLogo = () => (
  <svg
    ...
    className="instagram-logo" // Converted 'class' to 'className'
    fill="currentColor"
    height="29"
    role="img"
    viewBox="32 4 113 32"
    width="103"
    style={{ color: "#E4405F", width: "150px" }}
  >
    <title>Instagram</title>
    <path
      clipRule="evenodd" // Converted 'clip-rule' to 'clipRule'
      ...
      fill="currentColor"
      fillRule="evenodd" // Converted 'fill-rule' to 'fillRule'
    />
  </svg>
);
